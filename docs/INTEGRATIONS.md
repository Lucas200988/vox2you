...
| Instagram Direct + Messenger | `MetaMessengerProvider` | Implementado (Graph Send API, webhook `/webhooks/meta`, janela 24h sem templates); aguarda Página/token | Integrações → Instagram Direct + Messenger (`MESSENGER_*`) |
